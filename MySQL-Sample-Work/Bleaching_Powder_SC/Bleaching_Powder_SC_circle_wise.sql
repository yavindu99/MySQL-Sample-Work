...
WHERE og.name IN ('Corporation Group','District Group','Rural Group','DH Group', 'GH Group', 'WH Group', 'MCL Group', 'SDH 100 Group', 'SDH 50 Group', 'RH Group', 'PHC Group', 'SC')
...
GROUP BY sag1.name,sag1.district
ORDER BY sag1.name,sag1.district
