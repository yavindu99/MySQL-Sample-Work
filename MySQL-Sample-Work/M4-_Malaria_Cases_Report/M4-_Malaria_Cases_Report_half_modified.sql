...
CASE WHEN sag.dataelementid=8051 AND sag.categoryoptioncomboid=1 THEN sag.count END AS '8051_1', 
CASE WHEN sag.dataelementid=8053 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8053_1', 
CASE WHEN sag.dataelementid=8055 AND sag.categoryoptioncomboid=1 THEN sag.count END AS '8055_1', 
...
CASE WHEN sag.dataelementid=8052 AND sag.categoryoptioncomboid=1 THEN sag.count END AS '8052_1', 
CASE WHEN sag.dataelementid=8054 AND sag.categoryoptioncomboid=1 THEN sag.count END AS '8054_1', 
CASE WHEN sag.dataelementid=8056 AND sag.categoryoptioncomboid=1 THEN sag.count END AS '8056_2', 
...
FROM
(
SELECT asd.organisationunitid,asd.name,asd.fname,asd1.dataelementid,asd1.categoryoptioncomboid,
CASE WHEN asd1.value NOT IN ('true','false') THEN  SUM(IFNULL(asd1.value,0))
     WHEN asd1.value IN ('true','false') THEN asd1.value END AS 'value' ,
CASE WHEN asd1.value='true' THEN COUNT(asd1.value) END  AS 'count' 
FROM
(
