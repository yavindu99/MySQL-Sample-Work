...
SUM(IFNULL(sag1.8072_1,0))  AS '8072_1',
SUM(IFNULL(sag1.8073_1,0))  AS '8073_1',
SUM(IFNULL(sag1.8074_1,0))  AS '8074_1',
SUM(IFNULL(sag1.8075_1,0))  AS '8075_1',
SUM(IFNULL(sag1.8076_1,0))  AS '8076_1',
SUM(IFNULL(sag1.8077_1,0))  AS '8077_1',
SUM(IFNULL(sag1.8078_1,0))  AS '8078_1',
SUM(IFNULL(sag1.8079_1,0))  AS '8079_1',
SUM(IFNULL(sag1.8080_1,0))  AS '8080_1',
SUM(IFNULL(sag1.8029_1,0))  AS '8029_1',
SUM(IFNULL(sag1.8030_1,0))  AS '8030_1',
SUM(IFNULL(sag1.8558_1,0))  AS '8558_1',
SUM(IFNULL(sag1.8908_8,0))  AS '8908_8',
SUM(IFNULL(sag1.8908_7,0))  AS '8908_7',
SUM(IFNULL(sag1.8909_8,0))  AS '8909_8',
SUM(IFNULL(sag1.8909_7,0))  AS '8909_7',
SUM(IFNULL(sag1.8910_8,0))  AS '8910_8',
SUM(IFNULL(sag1.8910_7,0))  AS '8910_7',
SUM(IFNULL(sag1.8559_1,0))  AS '8559_1',
SUM(IFNULL(sag1.8560_1,0))  AS '8560_1',
SUM(IFNULL(sag1.8561_1,0))  AS '8561_1',
SUM(IFNULL(sag1.8562_1,0))  AS '8562_1',
SUM(IFNULL(sag1.8563_1,0)) AS '8563_1',
SUM(IFNULL(sag1.8564_1,0)) AS '8564_1',
SUM(IFNULL(sag1.8565_1,0)) AS '8565_1',
SUM(IFNULL(sag1.8083_1,0))  AS '8083_1',
SUM(IFNULL(sag1.8081_1,0))  AS '8081_1',
...
CASE WHEN sag.dataelementid=8072 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8072_1',
CASE WHEN sag.dataelementid=8073 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8073_1',
CASE WHEN sag.dataelementid=8074 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8074_1',
CASE WHEN sag.dataelementid=8075 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8075_1',
CASE WHEN sag.dataelementid=8076 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8076_1',
CASE WHEN sag.dataelementid=8077 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8077_1',
CASE WHEN sag.dataelementid=8078 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8078_1',
CASE WHEN sag.dataelementid=8079 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8079_1',
CASE WHEN sag.dataelementid=8080 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8080_1',
CASE WHEN sag.dataelementid=8029 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8029_1',
CASE WHEN sag.dataelementid=8030 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8030_1',
CASE WHEN sag.dataelementid=7663 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '7663_1',
CASE WHEN sag.dataelementid=8558 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8558_1',
CASE WHEN sag.dataelementid=8908 AND sag.categoryoptioncomboid=8 THEN sag.value END AS '8908_8',
CASE WHEN sag.dataelementid=8908 AND sag.categoryoptioncomboid=7 THEN sag.value END AS '8908_7',
CASE WHEN sag.dataelementid=8909 AND sag.categoryoptioncomboid=8 THEN sag.value END AS '8909_8',
CASE WHEN sag.dataelementid=8909 AND sag.categoryoptioncomboid=7 THEN sag.value END AS '8909_7',
CASE WHEN sag.dataelementid=8910 AND sag.categoryoptioncomboid=8 THEN sag.value END AS '8910_8',
CASE WHEN sag.dataelementid=8910 AND sag.categoryoptioncomboid=7 THEN sag.value END AS '8910_7',
CASE WHEN sag.dataelementid=8560 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8560_1',
CASE WHEN sag.dataelementid=8559 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8559_1',
CASE WHEN sag.dataelementid=8561 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8561_1',
CASE WHEN sag.dataelementid=8081 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8081_1',
CASE WHEN sag.dataelementid=8562 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8562_1',
CASE WHEN sag.dataelementid=8563 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8563_1',
CASE WHEN sag.dataelementid=8564 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8564_1',
CASE WHEN sag.dataelementid=8565 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8565_1',
CASE WHEN sag.dataelementid=8083 AND sag.categoryoptioncomboid=1 THEN sag.value END AS '8083_1'
...
(
SELECT dv.dataelementid,dv.categoryoptioncomboid,CASE WHEN dv.value='true' THEN 1 WHEN dv.value!='true' THEN dv.value END AS 'value',dv.sourceid,p.startdate
FROM datavalue dv
...
WHERE dv.dataelementid IN (8011,8013,8015,8017,8019,8021,8023,8025,8027,8012,8014,8016,8018,8020,8022,8024,8026.8028,
			...
			7421,7402,7519,7520,7521,7522,7523,8114,8072,8073,8074,8075,8076,8077,8078,8079,8080,8029,8030,7663,8558,8908,8909,8910,8559,8560,8561,
			8081,8562,8563,8563,8564,8565,8083)
