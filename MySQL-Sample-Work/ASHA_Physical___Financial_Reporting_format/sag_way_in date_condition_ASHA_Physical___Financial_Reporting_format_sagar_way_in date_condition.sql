...
(
	#During_the_month
	SELECT asd.organisationunitid,asd.name,asd.ou_name,asd1.dataelementid,asd1.categoryoptioncomboid,asd1.value AS 'value','curr_mn' AS 'time'
	FROM
	(
...
UNION	
	...
	SELECT asd.organisationunitid,asd.name,asd.ou_name,asd1.dataelementid,asd1.categoryoptioncomboid,asd1.value AS 'value','up_to_pre_mon' AS 'time'
	FROM
	(
	SELECT ou3.organisationunitid,ou.name,og.name AS 'gname',ou3.name AS 'ou_name'
	FROM orgunitgroupmembers ogm
...
UNION	
	...
	SELECT asd.organisationunitid,asd.name,asd.ou_name,asd1.dataelementid,asd1.categoryoptioncomboid,asd1.value AS 'value','up_to_curr_mon' AS 'time'
	FROM
	(
	SELECT ou3.organisationunitid,ou.name,og.name AS 'gname',ou3.name AS 'ou_name'
	FROM orgunitgroupmembers ogm
	...
	AND CASE WHEN MONTH('2013-11-01') BETWEEN 4 AND 12 THEN YEAR(p.startdate)=YEAR('2013-11-01') AND MONTH(p.startdate) BETWEEN MONTH(CONCAT(YEAR('2013-11-01'),'-','04','-','01')) AND MONTH('2013-11-01')
	         WHEN MONTH('2013-11-01') BETWEEN 1 AND 3  THEN YEAR(p.startdate) BETWEEN YEAR('2013-11-01')-1 AND YEAR('2013-11-01') AND 
	         p.startdate BETWEEN  CONCAT(YEAR('2013-11-01')-1,'-','04','-','01') AND '2013-11-01'
	     END
	AND periodtypeid = 3
