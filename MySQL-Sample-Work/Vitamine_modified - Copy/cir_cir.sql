#circle - circle
SELECT sag2.Circle,sag2.mon,'Vitamine A' AS 'section', 'Hepatitis B III' AS 'section1','Fully Immunized' AS 'section2', 
...
(
	...
	(	
		...
		asd1.dataelementid,asd1.categoryoptioncomboid,asd1.value,MONTH(asd1.startdate)
		FROM
			(
		...
		LEFT JOIN
			...
			(
			#financial year
			SELECT dv.dataelementid,dv.categoryoptioncomboid,dv.value,dv.sourceid,p.startdate,'curr' AS 'time'
			FROM datavalue dv
