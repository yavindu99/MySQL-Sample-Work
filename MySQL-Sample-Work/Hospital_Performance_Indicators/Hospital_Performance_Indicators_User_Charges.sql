...
SUM(IFNULL(6072_curr_mn,0)) AS '6072_curr_mn',
SUM(IFNULL(8946_curr_mn,0)) AS '8946_curr_mn',

SUM(IFNULL(6072_las_yr,0)) AS '6072_las_yr',
SUM(IFNULL(8946_las_yr,0)) AS '8946_las_yr',

SUM(IFNULL(6072_bef_2_yr,0)) AS '6072_bef_2_yr',
SUM(IFNULL(8946_bef_2_yr,0)) AS '8946_bef_2_yr'

FROM
(	
SELECT sag.ou_name,
CASE WHEN sag.dataelementid=8936 AND sag.time='cur_mn' THEN sag.value END AS '8936_curr_mn',
CASE WHEN sag.dataelementid=6072 AND sag.time='cur_mn' THEN sag.value END AS '6072_curr_mn',
CASE WHEN sag.dataelementid=8946 AND sag.time='cur_mn' THEN sag.value END AS '8946_curr_mn',

CASE WHEN sag.dataelementid=6072 AND sag.time='las_yr' THEN sag.value END AS '6072_las_yr',
CASE WHEN sag.dataelementid=8946 AND sag.time='las_yr' THEN sag.value END AS '8946_las_yr',

CASE WHEN sag.dataelementid=6072 AND sag.time='bef_2_yr' THEN sag.value END AS '6072_bef_2_yr',
CASE WHEN sag.dataelementid=8946 AND sag.time='bef_2_yr' THEN sag.value END AS '8946_bef_2_yr'
...
(	
	...
	WHERE dv.dataelementid IN (8936,6072,8946)
