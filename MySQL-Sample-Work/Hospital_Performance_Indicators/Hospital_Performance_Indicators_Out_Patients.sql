...
SUM(IFNULL(130_curr_mn,0)) AS '130_curr_mn',
SUM(IFNULL(8937_curr_mn,0)) AS '8937_curr_mn',

SUM(IFNULL(130_las_yr,0)) AS '130_las_yr',

SUM(IFNULL(130_bef_2_yr,0)) AS '130_bef_2_yr'

FROM
(	
SELECT sag.ou_name,
CASE WHEN sag.dataelementid=8936 AND sag.time='cur_mn' THEN sag.value END AS '8936_curr_mn',
CASE WHEN sag.dataelementid=130 AND sag.time='cur_mn' THEN sag.value END AS '130_curr_mn',
CASE WHEN sag.dataelementid=8937 AND sag.time='cur_mn' THEN sag.value END AS '8937_curr_mn',

CASE WHEN sag.dataelementid=130 AND sag.time='las_yr' THEN sag.value END AS '130_las_yr',

CASE WHEN sag.dataelementid=130 AND sag.time='bef_2_yr' THEN sag.value END AS '130_bef_2_yr'
