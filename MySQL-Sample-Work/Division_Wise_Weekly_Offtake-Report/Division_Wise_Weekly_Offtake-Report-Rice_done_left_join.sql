...
SUM(IFNULL(sag1.28,0)) AS '28_6',
SUM(IFNULL(sag1.30,0)) AS '30_8', 
SUM(IFNULL(sag1.31,0)) AS '31_9', 
SUM(IFNULL(sag1.32,0)) AS '32_10', 
SUM(IFNULL(sag1.33,0)) AS '33_11', 
SUM(IFNULL(sag1.34,0)) AS '34_12',
SUM(IFNULL(sag1.35,0)) AS '35_13',
SUM(IFNULL(sag1.123,0)) AS '123_121',
SUM(IFNULL(sag1.126,0)) AS '126_124',
SUM(IFNULL(sag1.37,0)) AS '37_15',
SUM(IFNULL(sag1.36,0)) AS '36_14',
SUM(IFNULL(sag1.28,0)+IFNULL(sag1.30,0)+IFNULL(sag1.31,0)+IFNULL(sag1.32,0)+IFNULL(sag1.33,0)+IFNULL(sag1.34,0)+
    IFNULL(sag1.35,0)+IFNULL(sag1.123,0)+IFNULL(sag1.126,0)+IFNULL(sag1.37,0)+IFNULL(sag1.36,0)) AS 'sub_total_1',
SUM(IFNULL(sag1.38,0)) AS '38_16',
SUM(IFNULL(sag1.39,0)) AS '39_17',
SUM(IFNULL(sag1.40,0)) AS '40_18',
SUM(IFNULL(sag1.117,0)) AS '117_115',
SUM(IFNULL(sag1.114,0)) AS '114_112',
SUM(IFNULL(sag1.41,0)) AS '41_19',
SUM(IFNULL(sag1.120,0)) AS '120_118',
SUM(IFNULL(sag1.42,0)) AS '42_20',
SUM(IFNULL(sag1.38,0)+IFNULL(sag1.39,0)+IFNULL(sag1.40,0)+IFNULL(sag1.117,0)+IFNULL(sag1.114,0)+IFNULL(sag1.41,0)+IFNULL(sag1.120,0)+IFNULL(sag1.42,0)) AS 'sub_total_2',
    
SUM(IFNULL(sag1.28,0)+IFNULL(sag1.30,0)+IFNULL(sag1.31,0)+IFNULL(sag1.32,0)+IFNULL(sag1.33,0)+IFNULL(sag1.34,0)+
    IFNULL(sag1.35,0)+IFNULL(sag1.123,0)+IFNULL(sag1.126,0)+IFNULL(sag1.37,0)+IFNULL(sag1.36,0)+
    IFNULL(sag1.38,0)+IFNULL(sag1.39,0)+IFNULL(sag1.40,0)+IFNULL(sag1.117,0)+IFNULL(sag1.114,0)+IFNULL(sag1.41,0)+IFNULL(sag1.120,0)+IFNULL(sag1.42,0)) AS 'grand_total'
...
AND p.startdate BETWEEN 2013-12-23 AND 2013-12-23
