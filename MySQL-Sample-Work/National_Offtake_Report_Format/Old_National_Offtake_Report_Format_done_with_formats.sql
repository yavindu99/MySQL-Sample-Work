SELECT 
CASE WHEN sag2.month=1 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')+1
     WHEN sag2.month=2 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')+1
     WHEN sag2.month=3 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')+1
     WHEN sag2.month=4 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')+1
     WHEN sag2.month=5 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')+1
     WHEN sag2.month=6 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')+1
     
     WHEN sag2.month=7 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')
     WHEN sag2.month=8 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')
     WHEN sag2.month=9 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')
     WHEN sag2.month=10 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')
     WHEN sag2.month=11 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')
     WHEN sag2.month=12 AND MONTH('2014-07-28') BETWEEN 7 AND 12 THEN   YEAR('2014-07-28')
     
     WHEN sag2.month=1 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')
     WHEN sag2.month=2 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')
     WHEN sag2.month=3 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')
     WHEN sag2.month=4 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')
     WHEN sag2.month=5 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')
     WHEN sag2.month=6 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')
     
     WHEN sag2.month=7 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')-1
     WHEN sag2.month=8 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')-1
     WHEN sag2.month=9 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')-1
     WHEN sag2.month=10 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')-1
     WHEN sag2.month=11 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')-1
     WHEN sag2.month=12 AND MONTH('2014-07-28') BETWEEN 1 AND 6 THEN   YEAR('2014-07-28')-1
...
#Rice
 '' AS 'A Rice',
 ROUND(SUM(sag2.30_8),2) AS '30_8',
 ROUND(SUM(sag2.31_9),2) AS '31_9',
 ROUND(SUM(sag2.32_10),2) AS '32_10',
 ROUND(SUM(sag2.33_11),2) AS '33_11',
 ROUND(SUM(sag2.34_12),2) AS '34_12',
 ROUND(SUM(sag2.35_13),2) AS '35_13',
 ROUND(SUM(sag2.123_121),2) AS '123_121',
 ROUND(SUM(sag2.123_121),2) AS '126_124',
 ROUND(SUM(sag2.37_15),2) AS '37_15',
 ROUND(SUM(sag2.36_14),2) AS '36_14',
 ROUND(SUM(sag2.Rice_sub_total_1),2) AS 'Rice_sub_total_1',
 
 ROUND(SUM(sag2.38_16),2) AS '38_16',
 ROUND(SUM(sag2.39_17),2) AS '39_17',
 ROUND(SUM(sag2.40_18),2) AS '40_18',
 ROUND(SUM(sag2.115_117),2) AS '115_117',
 ROUND(SUM(sag2.112_114),2) AS '112_114',
 ROUND(SUM(sag2.19_41),2) AS '19_41',
 ROUND(SUM(sag2.118_120),2) AS '118_120',
 ROUND(SUM(sag2.20_42),2) AS '20_42',
...
(
SELECT dv.sourceid,dv.dataelementid,dv.value,CONCAT(MONTH(p.startdate),' ',DATE_FORMAT(p.startdate,'%M')) AS 'month',YEAR(p.startdate) AS 'year'
FROM datavalue dv
...
AND CASE WHEN MONTH('2014-07-28') BETWEEN 7 AND 12 THEN YEAR(p.startdate) = YEAR('2014-07-28') AND MONTH(p.startdate) BETWEEN 7 AND MONTH('2014-07-28')
         WHEN  MONTH('2014-07-28') BETWEEN 1 AND 6 THEN YEAR(p.startdate) BETWEEN YEAR('2014-07-28')-1 AND YEAR('2014-07-28') AND p.startdate BETWEEN CONCAT(YEAR('2014-07-28')-1,'-',06,'-',01) AND CONCAT('2014-07-28')
END
...
FROM
(
SELECT os.organisationunitid,os.idlevel4,os.idlevel3,og.name AS 'gname',ou.name,os.level,ou.parentid,CONCAT(CASE WHEN MONTH('2014-07-28') IN (1,2,3,4,5,6,7,8,9) THEN '0'
													        WHEN MONTH('2014-07-28') IN (10,11,12) THEN '' END,MONTH('2014-07-28'),' ',DATE_FORMAT('2014-07-28','%M')) AS 'month',YEAR('2014-07-28') AS 'year'
FROM orgunitgroupmembers ogm
INNER JOIN orgunitgroup og ON ogm.orgunitgroupid = og.orgunitgroupid
INNER JOIN _orgunitstructure os ON ogm.organisationunitid=os.organisationunitid
INNER JOIN organisationunit ou ON ou.organisationunitid = os.idlevel3
...
WHERE dv.dataelementid IN (30,8,31,9,32,10,33,11,34,12,35,13,123,121,126,124,37,15,
			   ...
			   119,64,16,17,19,20)
AND dv.categoryoptioncomboid IN (1)
#AND WEEK(p.startdate)=WEEK('2014-07-28')
#AND MONTH(p.startdate)=MONTH('2014-07-28')
#AND YEAR(p.startdate) = MONTH('2014-07-28')
AND p.startdate BETWEEN '2014-07-28' AND '2014-07-28' 
