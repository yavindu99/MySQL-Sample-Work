...
SUM(IFNULL(sag1.50,0)+IFNULL(sag1.52,0)+IFNULL(sag1.53,0)+IFNULL(sag1.54,0)+IFNULL(sag1.55,0)+IFNULL(sag1.56,0)+IFNULL(sag1.122,0)+
IFNULL(sag1.125,0)+IFNULL(sag1.59,0)+IFNULL(sag1.58,0)) AS 'sub_total_1',
...
SUM(IFNULL(sag1.60,0)+IFNULL(sag1.61,0)+IFNULL(sag1.62,0)+IFNULL(sag1.116,0)+IFNULL(sag1.113,0)+IFNULL(sag1.63,0)+IFNULL(sag1.119,0)+IFNULL(sag1.64,0)) AS 'sub_total_2',

SUM(IFNULL(sag1.50,0)+IFNULL(sag1.52,0)+IFNULL(sag1.53,0)+IFNULL(sag1.54,0)+IFNULL(sag1.55,0)+IFNULL(sag1.56,0)+IFNULL(sag1.122,0)+
IFNULL(sag1.125,0)+IFNULL(sag1.59,0)+IFNULL(sag1.58,0)+IFNULL(sag1.60,0)+IFNULL(sag1.61,0)+IFNULL(sag1.62,0)+IFNULL(sag1.116,0)+IFNULL(sag1.113,0)+IFNULL(sag1.63,0)+IFNULL(sag1.119,0)+IFNULL(sag1.64,0))
AS 'grand_total'
