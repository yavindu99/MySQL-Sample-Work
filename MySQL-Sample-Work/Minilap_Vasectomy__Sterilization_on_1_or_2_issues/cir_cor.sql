SELECT sag6.circle,sag6.unit_name,sag6.mon_number,sag6.6224_1_fin_yr,sag6.6224_1_fin_yr_ela_prop_mini,sag6.mini_per_dur,sag6.mini_per_prog,sag6.mini_per_las_yr,
...
FROM
(
SELECT sag5.circle,sag5.unit_name,sag5.mon_number,sag5.6224_1_fin_yr,sag5.6224_1_fin_yr_ela_prop_mini,sag5.mini_per_dur,sag5.mini_per_prog,sag5.mini_per_las_yr,
...
FROM
(
SELECT sag4.circle,sag4.unit_name,sag4.mon_number,sag4.6224_1_fin_yr,sag4.6224_1_fin_yr_ela_prop_mini,sag4.mini_per_dur,sag4.mini_per_prog,sag4.mini_per_las_yr,
...
FROM
(
SELECT sag3.circle,sag3.unit_name,sag3.mon_number,sag3.6224_1_fin_yr,sag3.6224_1_fin_yr_ela_prop_mini,sag3.mini_per_dur,sag3.mini_per_prog,sag3.mini_per_las_yr,
...
FROM
(
SELECT sag2.circle,sag2.unit_name,sag2.mon_number,sag2.6224_1_fin_yr,sag2.6224_1_fin_yr_ela_prop_mini,sag2.mini_per_dur,sag2.mini_per_prog,sag2.mini_per_las_yr,
...
(
SELECT sag1.circle,sag1.unit_name,sag1.mon_number,
...
FROM
(
SELECT sag.circle,sag.unit_name,
...
(
	#Financial_Year
	SELECT asd.circle,asd.unit_name,asd.gname,asd1.dataelementid,asd1.categoryoptioncomboid,SUM(IFNULL(asd1.value,0)) AS 'value','fin_yr' AS 'time'
	FROM
	(
	...
	GROUP BY asd.circle,asd.unit_name,asd1.dataelementid
	
UNION


	#Current_Month
	SELECT asd.circle,asd.unit_name,asd.gname,asd1.dataelementid,asd1.categoryoptioncomboid,SUM(IFNULL(asd1.value,0)) AS 'value','cur_mon' AS 'time'
	FROM
	(
		SELECT ou2.organisationunitid,ou.name AS 'circle',ou1.name AS 'district',ou2.name AS 'unit_name',og.name AS 'gname'
		FROM orgunitgroupmembers ogm 
...
UNION
	...
	#Progressive
	SELECT asd.circle,asd.unit_name,asd.gname,asd1.dataelementid,asd1.categoryoptioncomboid,SUM(IFNULL(asd1.value,0)) AS 'value','prog' AS 'time'
	FROM
	(
		SELECT ou2.organisationunitid,ou.name AS 'circle',ou1.name AS 'district',ou2.name AS 'unit_name',og.name AS 'gname'
		FROM orgunitgroupmembers ogm 
...
UNION
	...
	#Last_Year
	SELECT asd.circle,asd.unit_name,asd.gname,asd1.dataelementid,asd1.categoryoptioncomboid,SUM(IFNULL(asd1.value,0)) AS 'value','las_yr' AS 'time'
	FROM
	(
		SELECT ou2.organisationunitid,ou.name AS 'circle',ou1.name AS 'district',ou2.name AS 'unit_name',og.name AS 'gname'
		FROM orgunitgroupmembers ogm 
...
GROUP BY sag1.circle,sag1.unit_name
)sag2
)sag3 
...
ORDER BY sag6.circle,sag6.unit_name